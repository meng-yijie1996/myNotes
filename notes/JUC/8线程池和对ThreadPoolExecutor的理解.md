...
Callable接口与Runnable接口**对比**：

1. Runnable的run()方法没有返回值，Callable的call()方法有返回值，在批处理业务，如转账，需要给一个返回结果的状态码回来，代表本次操作成功还是失败。
2. Runnable的run()方法不会抛异常，Callable的call()方法会抛异常，多个线程各自抛独立的异常。
3. 实现接口时，需要实现的方法不同：run（)与call()
...
![image-20200317175202647](https://gitee.com/moxi159753/LearningNotes/raw/master/%E6%A0%A1%E6%8B%9B%E9%9D%A2%E8%AF%95/JUC/10_%E7%BA%BF%E7%A8%8B%E6%B1%A0/images/image-20200317175202647.png)
